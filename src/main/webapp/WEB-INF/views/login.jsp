...
<head>
    ...
    <title>Sign In | Prathmesh Laptop Shop</title>
    ...
    <main class="relative z-10 flex-1 flex items-center justify-center px-4">
        <div class="w-full max-w-md px-6 py-10 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl shadow-black/40">
            ...
            <div class="text-center mb-8">
                <h2 class="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Welcome Back</h2>
                <p class="text-xs text-gray-400 mt-1">Sign in to access your dashboard</p>
            </div>
            ...
            <form action="/loginCustomer" method="POST" class="space-y-5">
                <div>
                    ...
                    <input type="text" name="User_Name" required placeholder="Enter username"
                           class="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-blue-500 focus:outline-none transition-all text-sm">
                </div>

                <div>
                    <div class="flex justify-between items-center mb-1">
                        <label class="block text-xs font-semibold uppercase tracking-wider text-gray-400">Password</label>
            ...
            <div class="text-center mt-6">
                <p class="text-xs text-gray-400">Don't have an account? <a href="/register" class="text-blue-400 hover:underline ml-1">Create Account</a></p>
            </div>
